<template>
  <div class="order-item">
    <div class="head">
      ...
      <span v-if="order.orderState === 2" class="down-time">
    ...
    <div class="body">
      ...
      <div class="column state">
        ...
        <p v-if="order.orderState === 4">
          <a class="green" href="javascript:;">查看商品</a>
        </p>
      ...
      <div class="column action">
        ...
        <!-- 已完成：查看详情，再次购买，申请售后 -->
        <!-- 已取消：查看详情 -->
        <XtxButton @click="$router.push(`/member/pay?orderId=${order.id}`)" v-if="order.orderState === 2" type="primary" size="small"
          >立即付款</XtxButton
        >
